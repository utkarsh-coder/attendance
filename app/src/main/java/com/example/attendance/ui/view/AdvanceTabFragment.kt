...
class AdvanceTabFragment : Fragment() {
    ...
    private val advanceViewModel: AdvanceViewModel by activityViewModels {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        advanceViewModel.getAdvancesForEmployee(employeeId).observe(viewLifecycleOwner) { list ->
            ...
            binding.tvAdvanceCount.text = "${list.size} record${if (list.size == 1) "" else "s"}"
                ...
                when {
                    ...
                    description.isEmpty() ->
                        ...
                        if (amount == null || amount <= 0) {
                            ...
                            advanceViewModel.updateAdvance(advance.copy(amount = amount, description = description))
